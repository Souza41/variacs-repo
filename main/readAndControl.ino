...
void readAndControl()
{
  ...
  ajustarTensao(voltageRead1, voltage_1, fimDeCursoCW1, fimDeCursoCCW1, motorCW1, motorCCW1, 1, posto1);
  ajustarTensao(voltageRead2, voltage_2, fimDeCursoCW2, fimDeCursoCCW2, motorCW2, motorCCW2, 1, posto2);
  ajustarTensao(voltageRead3, voltage_3, fimDeCursoCW3, fimDeCursoCCW3, motorCW3, motorCCW3, 2, posto3);
  ajustarTensao(voltageRead4, voltage_4, fimDeCursoCW4, fimDeCursoCCW4, motorCW4, motorCCW4, 2, posto4);
